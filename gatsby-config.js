...
module.exports = {
  siteMetadata: {
    ...
    author: {
      ...
      <p>I have professional experience in the production of an <strong>Android</strong> mobile application and an <strong>AngularJS</strong> online application. I also have experience with REST services development in Java and front-end development in Angular 2+.
      Currently, I am full-stack software developer with Vanguard.</p> 
